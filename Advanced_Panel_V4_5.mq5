...
const int PANEL_HEIGHT = 570;  // بعد از ادغام ردیف Lot Size با ردیف Buy/Sell و جابجایی آن بالای EA TREND LINES
...
void CreatePanel()
{
   ...
   CreateButton(BTN_BUY, "BUY", g_panelX + 12, g_panelY + 254, 70, 26, C'0,130,0', clrWhite);
   CreateLabel(LBL_LOT, "LOT", g_panelX + 93, g_panelY + 254, clrWhite, 7, true);
   CreateEdit(EDIT_LOT, DoubleToString(g_panelLot, 2), g_panelX + 85, g_panelY + 266, 58, 14);
   CreateButton(BTN_SELL, "SELL", g_panelX + 145, g_panelY + 254, 70, 26, C'170,0,0', clrWhite);
   ...
   CreateButton(BTN_BUY_PENDING, "BUY PENDING", g_panelX + 12, g_panelY + 374, 98, 24, C'0,90,0', clrWhite);
   CreateButton(BTN_SELL_PENDING, "SELL PENDING", g_panelX + 117, g_panelY + 374, 98, 24, C'130,0,0', clrWhite);

   CreateButton(BTN_CLOSE_BUY, "CLOSE BUYS", g_panelX + 12, g_panelY + 404, 98, 24, C'180,90,0', clrWhite);
   CreateButton(BTN_CLOSE_SELL, "CLOSE SELLS", g_panelX + 117, g_panelY + 404, 98, 24, C'180,90,0', clrWhite);

   CreateButton(BTN_CLOSE_HALF, "CLOSE 50%", g_panelX + 12, g_panelY + 434, 98, 24, C'100,100,0', clrWhite);
   CreateButton(BTN_MANUAL_BE, "MANUAL BE", g_panelX + 117, g_panelY + 434, 98, 24, C'40,100,150', clrWhite);
   
   CreateButton(BTN_CLOSE, "CLOSE ALL", g_panelX + 12, g_panelY + 464, 203, 26, C'70,70,70', clrWhite);

   // ردیف تشخیص روند M5 / M15 / M30 / H1 - دقیقا زیر دکمه CLOSE ALL (Close All bottom edge = panelY + 490)
   int trendRowY = g_panelY + 498;
   ...
   CreateLabel(LBL_BE_TS_STATUS, "پوزیشنی انتخاب نشده", g_panelX + 12, g_panelY + 522, clrSilver, 8, false);
   CreateButton(BTN_TOGGLE_BE_TS, "TOGGLE BE/TS FOR SELECTED", g_panelX + 12, g_panelY + 538, 203, 22, C'70,70,70', clrWhite);
